...
/**
 * Created by chenwenfa on 2016/6/23.
 * Desc:
 */
/*
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private TextView captureMaskBottom;

    private Rect mCropRect = null;
   // private MyTitle zallgoTitle;
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.zx_activity_capture);
    ...
    public void restartPreviewAfterDelay(long delayMS) {
        if (handler != null) {
            handler.sendEmptyMessageDelayed(ZX_RESTART_PREVIEW, delayMS);
        }
    }
