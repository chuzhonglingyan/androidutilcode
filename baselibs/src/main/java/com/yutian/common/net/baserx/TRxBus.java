 ...
 */
public class TRxBus {
    private static TRxBus instance;

    public static synchronized TRxBus getInstance() {
        if (null == instance) {
            instance = new TRxBus();
        }
        return instance;
     ...
     * @return
     */
    public TRxBus OnEvent(Observable<?> mObservable, Action1<Object> mAction1) {
     ...
     */
    @SuppressWarnings("rawtypes")
    public TRxBus unregister(@NonNull Object tag,
