...
public class PhoneUtils {
    ...
    public static boolean isPhone() {
        TelephonyManager tm = (TelephonyManager) AppContext.getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) AppContext.getApplicationContext()
    ...
    public static void dial(String phoneNumber) {
        AppContext.getApplicationContext().startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + phoneNumber)));
    }
    ...
    public static void call(String phoneNumber) {
        AppContext.getApplicationContext().startActivity(new Intent("android.intent.action.CALL", Uri.parse("tel:" + phoneNumber)));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(AppContext.getApplicationContext(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = AppContext.getApplicationContext().getContentResolver();
