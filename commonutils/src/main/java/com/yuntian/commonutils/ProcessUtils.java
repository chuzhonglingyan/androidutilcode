...
public class ProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager manager = (ActivityManager) AppContext.getApplicationContext().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (list.size() > 0) {// 有"有权查看使用权限的应用"选项
                try {
                    ApplicationInfo info = packageManager.getApplicationInfo(AppContext.getApplicationContext().getPackageName(), 0);
                    AppOpsManager aom = (AppOpsManager) AppContext.getApplicationContext().getSystemService(Context.APP_OPS_SERVICE);
                    ...
                    UsageStatsManager usageStatsManager = (UsageStatsManager) AppContext.getApplicationContext().getSystemService(Context.USAGE_STATS_SERVICE);
    ...
    public static Set<String> getAllBackgroundProcesses() {
        ActivityManager am = (ActivityManager) AppContext.getApplicationContext().getSystemService(Context.ACTIVITY_SERVICE);
