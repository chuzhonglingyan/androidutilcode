...
public class DeviceUtils {
    ...
    public static String getAndroidID() {
        return Settings.Secure.getString(AppContext.getApplicationContext().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    public static void reboot(String reason) {
        PowerManager mPowerManager = (PowerManager) AppContext.getApplicationContext().getSystemService(Context.POWER_SERVICE);
        try {
