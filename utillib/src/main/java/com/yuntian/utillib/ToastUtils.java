...
public class ToastUtils {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(AppContext.getApplicationContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(AppContext.getApplicationContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(AppContext.getApplicationContext(), text, duration);
        } else {
            sToast.setText(text);
