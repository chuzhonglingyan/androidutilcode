...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = AppContext.getApplicationContext().getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = AppContext.getApplicationContext().getResources().getDisplayMetrics().scaledDensity;
